...
namespace DAO
{
    public class GiangVienDAO
    {
        ...
        {
            string query = string.Format("EXEC ChinhSuaThongTinGiangVien @MaGV = '{0}', @Email = '{1}', @SDT = '{2}', @NgaySinh = '{3}', @DiaChi = '{4}', @HoTen = N'{5}', @GioiTinh = N'{6}';", MaGV, Email, SDT, NgaySinh.ToString("yyyy-MM-dd"), DiaChi, HoTen, GioiTinh);
